...
parser.add_argument("--nt_val", type=int, default=24, help="number of time steps for validation")
...
if __name__ == '__main__':
    ...
    for itr in range(1, args.niters + 1):
        ...
        #       
                ...
                sPath = os.path.join(args.save, 'figs', start_time + '_{:04d}.png'.format(itr))
                plot_1d(net, p_samples, nt_val, sPath, sTitle=' itr {:d}-  loss {:.2f}   ,  alph {:.1f} {:.1f}  '
                            ' nt {:d}   m {:d}  nTh {:d}  '.format( itr,best_loss, alph[1], alph[2], nt, m, nTh))
